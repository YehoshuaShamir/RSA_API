...
class rsa_api_test(unittest.TestCase):
    ...
    def test_DEVICE_GetNomenclature_py_rsa306b(self):
        self.assertEqual(DEVICE_GetNomenclature_py(), 'RSA306B')
    ...
    def test_DEVICE_GetFWVersion_py(self):
        self.assertEqual(DEVICE_GetFWVersion_py(), 'V1.7')

    def test_DEVICE_GetFPGAVersion_py(self):
        self.assertEqual(DEVICE_GetFPGAVersion_py(), 'V2.1')
    ...
    def test_DEVICE_GetInfo_py(self):
        ...
        self.assertEqual(info['fwVersion'], b'V1.7')
        self.assertEqual(info['fpgaVersion'], b'V2.1')
    ...
    def test_CONFIG_GetMaxCenterFreq_py_rsa507a(self):
        self.assertEqual(CONFIG_GetMaxCenterFreq_py(), 6.2e9)
    ...
    def test_TRIG_TriggerSource(self):
        source = [TriggerSource.TriggerSourceIFPowerLevel,
                  TriggerSource.TriggerSourceExternal]
        for s in source:
    ...
    def test_TRIG_TriggerTransition(self):
        ...
        self.assertRaises(TypeError, TRIG_SetTriggerTransition_py,
                          'transition')
    ...
    def test_IQSTREAM_SetOutputConfiguration_py(self):
        ...
        for d in dest:
            for t in dtype:
                if d is IQSOUTDEST.IQSOD_FILE_TIQ and t in [
                    IQSOUTDTYPE.IQSODT_SINGLE,
                    IQSOUTDTYPE.IQSODT_SINGLE_SCALE_INT32]:
    ...
    def test_GNSS_GetHwInstalled_py(self):
        self.assertFalse(GNSS_GetHwInstalled_py())
